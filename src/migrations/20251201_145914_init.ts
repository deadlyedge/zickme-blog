...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_profile_social_links_platform" AS ENUM('GitHub', 'LinkedIn', 'Twitter', 'Instagram', 'YouTube', 'Other');
  CREATE TYPE "public"."enum_profile_skills_technologies_level" AS ENUM('beginner', 'intermediate', 'advanced', 'expert');
  ...
  CREATE TABLE "profile_skills_technologies" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  	"level" "enum_profile_skills_technologies_level"
  );
  ...
  ALTER TABLE "profile_skills_technologies" ADD CONSTRAINT "profile_skills_technologies_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."profile_skills"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "profile_skills_technologies_order_idx" ON "profile_skills_technologies" USING btree ("_order");
  CREATE INDEX "profile_skills_technologies_parent_id_idx" ON "profile_skills_technologies" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "profile_skills_technologies" CASCADE;
  ...
  DROP TYPE "public"."enum_profile_skills_technologies_level";
